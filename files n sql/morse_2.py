...
url = 'http://codingdojang.com/scode/469?langby=python#answer-filter-area'
...
for t in soup.select('div.markdown_area.answer-content > table > tbody tr td'): #주소1
...
for i in range(int(len(soup.select('div.markdown_area.answer-content > table tr td'))/2)): #주소1
    #dictionary 형태로 저장.
